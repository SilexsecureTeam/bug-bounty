            ...
            <div className="mx-auto max-w-7xl px-4 py-2 sm:px-6 lg:px-8">
                <div className="flex h-16 items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex items-center gap-3">
                            <img src={DefcommLogo} alt="" className="md:-ml-5!" />
                            {/* <div className="h-9 w-9 rounded-md bg-[#122022] flex items-center justify-center text-sm font-bold text-white">DF</div> */}
                            <div className="hidden md:block">
                                <div className="text-sm font-semibold text-white">Welcome back, Chike</div>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        {/* <button className="rounded-md p-1 hover:bg-[#0f1418]">
                            <svg viewBox="0 0 24 24" fill="none" className="w-5 h-5 text-[#c6d0c0]" aria-hidden>
                                <path d="M15 17H9" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                <path d="M12 3v1m6 4v3a6 6 0 01-6 6 6 6 0 01-6-6V7" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                            </svg>
                        </button> */}
