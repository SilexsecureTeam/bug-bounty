    ...
    <>
      ...
      >
        <div className="flex items-center justify-between">
          ...
          <button onClick={onClose} className="sm:hidden text-[#9aa4b0]">
            ✕
          </button>
        </div>
        ...
        <button
          ...
          className="mt-3 flex w-full items-center gap-3 bg-red-800 rounded-md px-3 py-2 text-sm font-semibold text-left text-[#b9c0cc] hover:bg-red-900"
        >
          <span className="h-8 w-8 flex items-center justify-center rounded-md bg-red-900">
            ⤓
          </span>
          Sign Out
        </button>
        ...
        <div className="mb-0! mt-[23vh] border-t border-[#111316] pt-6">
          ...
          >
            ...
            <div className="hidden sm:block text-right">
              ...
              <div className="text-xs text-[#9ba0ad] group-hover:text-[#9fc24d] transition-colors">
                Account settings
              </div>
            </div>
          </div>
