...
const socialLinks = [
  { label: "Twitter", href: "https://x.com/defcomms?s=21" },
  {
    label: "LinkedIn",
    icon: linkedIn,
    href: "https://www.linkedin.com/company/defcomm-solutions/",
  },
  {
    label: "Instagram",
    icon: instagram,
    href: "https://www.instagram.com/defcomm_solution?igsh=MWhuYzF5bGJ1ZnFlbQ==",
  },
  {
    label: "YouTube",
    icon: youtube,
    href: "https://youtube.com/@defcommng?si=ij0cqN_d63D4xkBf",
  },
];
...
const speakerCardStyles = {
  text: {
    ...
    accent:
      "bg-linear-to-br from-[#1F3513] via-[#3C7A19] to-[#89D12F] text-white",
  },
  image: "bg-[#202227]",
};
...
export default function Landing() {
  ...
  return (
    <div className="bg-[#060706] text-white">
      <Helmet>
        <title>
          African Defence Tech | Sovereign Security, Cyber & Defence Innovation
        </title>
        <meta
          name="description"
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage:
              "linear-gradient(#1A230A 1px, transparent 1px), linear-gradient(90deg, #1A230A 1px, transparent 1px)",
              ...
              <div className="relative w-full max-w-[550px] aspect-square">
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20 flex flex-col items-center">
                  <div className="relative flex h-28 w-28 items-center justify-center rounded-full border-2 border-[#9ECB32] bg-[#050605] shadow-[0_0_40px_rgba(158,203,50,0.2)]">
                    <Satellite
                      className="h-12 w-12 text-[#9ECB32] animate-pulse"
                      strokeWidth={1.5}
                    />
                ...
                <div className="absolute top-[32%] left-[15%] -translate-x-1/2 z-20 flex flex-col items-center">
                  <div className="flex h-24 w-16 flex-col items-center justify-center rounded-[20px] border-2 border-[#9ECB32] bg-[#0B0E07]">
                    <ShieldCheck
                      className="h-6 w-6 text-[#9ECB32] mb-1"
                      strokeWidth={1.5}
                    />
                    <div className="h-1 w-6 rounded-full bg-[#36460A]"></div>
                  </div>
                  <div className="mt-2 text-center">
                    <span className="block text-lg font-black tracking-widest text-[#9ECB32]">
                      DOS
                    </span>
                    <span className="text-[10px] font-medium text-[#D7E4BB]">
                      Defcomm Secure OS
                    </span>
                  </div>
                </div>
      ...
      >
        <div
          className="reveal-child flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between"
      ...
      <div className="relative z-10 mx-auto flex max-w-7xl flex-col gap-16 px-6 pb-24 pt-10 sm:px-10 lg:gap-20 lg:px-0">
          ...
          >
            <div className="space-y-6">
              ...
              <p className="text-base leading-relaxed text-[#173008]">
                Africa’s security landscape is rapidly evolving, driven by
                digital transformation, emerging cyber threats, and the
                increasing reliance on connected systems across defence,
                government, and critical infrastructure. Fortifying Africa’s
                Digital Defence Future represents a strategic commitment to
                strengthening the continent’s resilience through indigenous
                technology, secure innovation, and collaborative defence
                ecosystems.
                <br />
                <br />
                This vision emphasizes the development and deployment of secure
                communications, cybersecurity capabilities, wargaming and
                simulation technologies, and resilient digital infrastructure
                tailored to Africa’s unique operational environments. It
                prioritizes sovereignty, trust, and readiness, ensuring that
                sensitive defence and security operations remain protected from
                external interference and evolving cyber risks.
              </p>
            </div>
            <a
          ...
          <div className="grid gap-8 lg:grid-cols-1">
            ...
            >
              ...
              <p className="mt-5 text-sm leading-relaxed text-[#F4FCE8]">
                Defcomm's flagship programme harmonises strategic intelligence,
                live bounty testing, and rapid deployment teams to lock down the
                next frontier of digital sovereignty.
              </p>
            </article>
              ...
              <ul className="mt-6 grid gap-3 text-sm leading-relaxed text-[#1C2810]">
                {impactBullets.map((item, index) => (
                  <li
                    ...
                    style={{
                      "--reveal-child-delay": `${0.35 + index * 0.07}s`,
                    }}
                  >
        ...
        >
          <div
            className="reveal-child flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between"
            style={{ "--reveal-child-delay": "0.08s" }}
          >
            <div>
        ...
        >
            ...
            {sponsorReasons.map(({ title, body, number }, index) => (
              ...
              >
                <div className="flex flex-col gap-4">
                  <span className="text-5xl font-black tracking-tight text-[#9ECB32]">
                    {number}
                  </span>
          ...
          <div className="flex flex-col gap-6">
            <div
              className="reveal-child flex flex-col gap-3 text-white"
              style={{ "--reveal-child-delay": "0.38s" }}
            >
              <h3 className="text-4xl font-black uppercase tracking-[0.25em] sm:text-5xl">
                Register Now
              </h3>
              <p className="max-w-lg text-sm text-[#B6C197]">
                Secure your spot at the Bug Bounty programme 2025 and join the
                future of cyber security.
              </p>
            </div>

            <div
              className="reveal-child relative overflow-hidden rounded-[48px] border border-[#242A1A] bg-[#0F1011] p-10 shadow-[0_35px_80px_rgba(8,10,5,0.55)]"
              style={{ "--reveal-child-delay": "0.46s" }}
            >
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex flex-wrap items-baseline gap-6 text-[#F4F8E8]">
                    <div className="flex flex-col items-center gap-2">
                      ...
                      <span className="text-xs uppercase tracking-[0.4em] text-[#7D8A5A]">
                        Days
                      </span>
                    </div>
                    <span className="text-5xl font-light text-[#495024]">
                      :
                    </span>
                    <div className="flex flex-col items-center gap-2">
                      <span className="text-5xl font-black tracking-widest">
        ...
        >
          <div
            className="reveal-child flex flex-col gap-10 lg:flex-row lg:gap-16"
            style={{ "--reveal-child-delay": "0.08s" }}
          >
            <div className="flex-1 space-y-8">
              <div className="space-y-4">
                ...
                <p className="max-w-lg text-sm text-[#C7D2B7]">
                  Have questions about the Programme? Need help with
              ...
              <div className="grid gap-8 sm:grid-cols-2">
                <div
                  className="reveal-child space-y-3"
                  style={{ "--reveal-child-delay": "0.2s" }}
                >
                  <h3 className="text-sm font-semibold uppercase tracking-[0.35em] text-[#9ECB32]">
                    Contact Us
                  </h3>
                  <ul className="space-y-2 text-sm text-[#E9F0DA]">
                    {contactDetails.phones.map((phone, index) => (
                      <li
                        ...
                        style={{
                          "--reveal-child-delay": `${0.26 + index * 0.06}s`,
                        }}
                      >
                        {phone}
                      </li>
                ...
                <div
                  className="reveal-child space-y-3"
                  style={{ "--reveal-child-delay": "0.32s" }}
                >
                  <h3 className="text-sm font-semibold uppercase tracking-[0.35em] text-[#9ECB32]">
                    Event Location
                  </h3>
                ...
                <div
                  className="reveal-child space-y-3"
                  style={{ "--reveal-child-delay": "0.44s" }}
                >
                  <h3 className="text-sm font-semibold uppercase tracking-[0.35em] text-[#9ECB32]">
                    Follow Us
                  </h3>
                  <div className="flex items-center gap-3">
                    {socialLinks.map(({ label, href, icon }, index) => (
                      <a
                        ...
                        style={{
                          "--reveal-child-delay": `${0.5 + index * 0.05}s`,
                        }}
                      >
            ...
            <div className="flex-1">
              <div
                className="reveal-child rounded-[36px] border border-[#2B2D31] bg-[#F2F3F8] p-3 sm:p-8 text-[#1B2126] shadow-[0_30px_70px_rgba(7,8,9,0.45)]"
                style={{ "--reveal-child-delay": "0.28s" }}
              >
                ...
                <p className="mt-3 text-sm text-[#4B545E]">
                  Reach out with inquiries about sponsorships, partnerships, or
                  event details.
                </p>
                <form className="mt-8 space-y-5">
                  {[
                    ...
                    <label key={name} className="block space-y-2">
                      <span className="text-xs font-semibold uppercase tracking-[0.35em] text-[#6B7683]">
                        {label}
                      </span>
                      <input
                        type={type}
