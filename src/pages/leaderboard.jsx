...
const leaderboardEntries = [
  { rank: 1, handle: "@cyberhunter", name: "Cyber Security Analyst", points: 1250, bugsFound: 15, reward: "₦150,000" },
  { rank: 2, handle: "@cyberhunter", name: "Cyber Security Analyst", points: 1000, bugsFound: 12, reward: "₦150,000" },
  { rank: 3, handle: "@cyberhunter", name: "Cyber Security Analyst", points: 950, bugsFound: 10, reward: "₦150,000" },
  { rank: 4, handle: "@cyberhunter", name: "Cyber Security Analyst", points: 800, bugsFound: 8, reward: "₦150,000" },
  { rank: 5, handle: "@cyberhunter", name: "Cyber Security Analyst", points: 750, bugsFound: 7, reward: "₦150,000" },
  { rank: 6, handle: "@cyberhunter", name: "Cyber Security Analyst", points: 700, bugsFound: 6, reward: "₦150,000" },
  { rank: 7, handle: "@cyberhunter", name: "Cyber Security Analyst", points: 650, bugsFound: 5, reward: "₦150,000" },
  { rank: 8, handle: "@cyberhunter", name: "Cyber Security Analyst", points: 600, bugsFound: 4, reward: "₦150,000" },
  { rank: 9, handle: "@cyberhunter", name: "Cyber Security Analyst", points: 550, bugsFound: 3, reward: "₦150,000" },
  { rank: 10, handle: "@cyberhunter", name: "Cyber Security Analyst", points: 500, bugsFound: 3, reward: "₦150,000" }
];
...
export default function Leaderboard() {
  const rows = useMemo(() => leaderboardEntries, []);

  return (
    <div className="min-h-screen bg-[#04070F] text-white py-28 px-4 lg:px-0">
        ...
        <header className={`flex flex-col gap-6 rounded-3xl border border-[#1C2538]/80 ${baseCardGradient} p-8 shadow-[0_30px_90px_rgba(4,7,15,0.55)] backdrop-blur-md`}
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <button className="inline-flex items-center justify-center rounded-full bg-[#95D549] px-6 py-3 text-sm font-semibold text-[#0A1205] shadow-[0_18px_36px_rgba(149,213,73,0.38)] transition-transform duration-150 hover:-translate-y-0.5">
                Submit a report
              </button>
